...
//        List<WebElement> facebook = WebDriverManager.getDriver().findElements(By.xpath("//ul[@class='social-icon-one']//span[@class='icon fa fa-facebook']"));
//        for (int i = 0; i < facebook.size(); i++) {
//            Assert.assertTrue(WebDriverManager.isDisplayed(facebook.get(i)));
//            WebDriverManager.click(facebook.get(i));
...
//        }
    ...
    public void all_twitter_buttons_should_take_to_twitter_pages() {
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[1]/div[1]/div[2]/ul[1]/li[2]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[2]/div[1]/div[2]/ul[1]/li[2]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[3]/div[1]/div[2]/ul[1]/li[2]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[4]/div[1]/div[2]/ul[1]/li[2]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
    }
    ...
    public void all_skype_buttons_should_take_to_skype_pages() {
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[1]/div[1]/div[2]/ul[1]/li[3]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[2]/div[1]/div[2]/ul[1]/li[3]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[3]/div[1]/div[2]/ul[1]/li[3]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[4]/div[1]/div[2]/ul[1]/li[3]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
    }
    ...
    public void all_linked_in_buttons_should_take_to_linked_in_pages() {
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[1]/div[1]/div[2]/ul[1]/li[4]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[2]/div[1]/div[2]/ul[1]/li[4]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[3]/div[1]/div[2]/ul[1]/li[4]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
        WebDriverManager.getDriver().findElement(By.xpath("//body[1]/div[1]/section[5]/div[1]/div[2]/div[4]/div[1]/div[2]/ul[1]/li[4]/a[1]/span[1]")).click();
        System.out.println(WebDriverManager.getDriver().getTitle());
        WebDriverManager.getDriver().navigate().back();
