...
public interface CommonPage {
    ...
    String XPATH_TEMPLATE_NAVIGATION_BAR = "%s";
    String XPATH_TEMPLATE_TOP_BAR_MENU = "//div//a[text()='%s']";
    String XPATH_TEMPLATE_LANGUAGE_SELECTION = "//ul[@class='dropdown-menu style-one']/li/a[text()='%s']";
